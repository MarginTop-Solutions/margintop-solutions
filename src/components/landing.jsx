    ...
    return(
        ...
        // }}
         className='font-work_sans h-full overflow-y-hidden'>
            ...
            <div className='min-h-[100vh] px-40 sm:px-4 py-6 '>
                <div className='top h-[10vh]'>
                    <img src="/images/logo.png" className='h-[10vh] sm:h-[4vh]'/>
                </div>
                <div data-aos="fade-down" className='w-[55%] mt-10 sm:w-full h-[60vh] gap-2 flex flex-col justify-center items-start '>
                    <h1 className='text-[64px]  font-medium tracking-tighter leading-[60px]'>ELEVATE YOUR BUSINESS WITH US</h1>
                    <p className='text-[#2D3031] pl-[4px] py-2'>WE&apos;RE MAKING A SIGNIFICANT IMPACT BY ASSISTING NUMEROUS CLIENTS. IT&apos;S TRULY REWARDING.</p>
                    <a target="_blank" href="https://www.linkedin.com/company/96658232/admin/dashboard/">
                    <button className='px-8 flex items-center justify-center whitespace-nowrap py-[14px] bg-black text-white rounded-md font-medium'>
