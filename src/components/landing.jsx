...
<<<<<<< HEAD
            <div className='min-h-[95vh] px-40 sm:px-4 py-6 flex flex-col justify-between'>
=======
            <div className='sm:min-h-[95vh] min-h-[100vh] px-40 sm:px-4 py-6 flex flex-col justify-between'>
>>>>>>> origin/samir
                <div className='top h-[10vh]'>
                    <img src="/images/logo.png" className='h-[10vh] sm:h-[6vh]'/>
                </div>
                <div data-aos="fade-down" className='w-[55%] sm:w-full  gap-2 flex flex-col justify-center items-start '>
                    <h1 className='text-[64px] font-medium tracking-tighter leading-[60px]'>WE ARE GLAD <br/>YOU MADE IT</h1>
                    <p className='text-[#242627] pl-[4px] text-[18px] py-2'>AT YOUR SERVICE 24/7</p>
                    <a target="_blank" href="https://www.linkedin.com/company/96658232/admin/dashboard/">
                    <a href="mailto:hello@margintopsolutions.com" className='px-8 flex items-center justify-center whitespace-nowrap py-[14px] bg-black text-white rounded-md font-medium'>
                        Contact Us &nbsp;<FaArrowRight/>
                    </a>
                    </a>
                </div>
                <div className='flex text-[30px] items-center justify-start gap-4 mb-6'>
                    <a target='_blank' href="https://www.linkedin.com/company/margintop-solutions" className=' text-[#2D3031]'><IoLogoLinkedin/></a>
                    <a target='_blank' href="https://www.instagram.com/margintopsolutions/" className=' text-[#2D3031]'><IoLogoInstagram/></a>
